...
class _CustomerWorkoutPageState extends State<CustomerWorkoutPage> {
  ...
  void initState() {
    ...
    if (workoutExists) {
      Workout workout = Workout.fromJson(jsonDecoder.convert(paramValue));
            ...
            child: Column(
              ...
              children: [
                Padding(
                  ...
                  child: Text(
                      store.workoutSelected!.description ?? 'Sem descrição',
                ...
                ...store.workoutSelected!.exercises.map((e) => Padding(
                      ...
                      child: ListItem(
                        title: e.name,
                        description:
                            'Séries: ${e.sets}   Repetições: ${e.reps}   Peso: ${e.weight ?? '-'}',
                        onTap: () {
                          Routefly.push(routePaths
                              .customers.workout.exercise.$item
                              .changes({
